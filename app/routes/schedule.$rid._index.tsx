    ...
    return <main>
        <section className="scheduler">
            ...
            <h2>{room.department} {room.id} - {room.name}</h2>
                ...
                <Form ref={formRef} className="time-slots-container" onSubmit={(e) => {e.preventDefault();handleSubmit(e);}} method="post" action="" id="time-slots-form">
                    ...
                    <input type="text" id="name" name="name" className="long" required={true} onChange={(e) => {setTitle(e.target.value);checkIsValid()}} value={title} placeholder="E.g. CIS Project Meeting, mx 30 chars" maxLength={30}></input>
